...
export class SSEBuilder {
    ...
    constructor(messageId, model, inputTokens) {
    ...
    emitTopLevelError(errorMessage) {
 ...
 */
export function getUserFacingErrorMessage(error, timeoutMs) {
...
//# sourceMappingURL=sse-transformer.js.map